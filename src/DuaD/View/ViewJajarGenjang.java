...
public class ViewJajarGenjang extends JFrame{
    
    //Membuat JLabel
    JLabel Header = new JLabel("MENU HITUNG");
    JLabel SubHeader1 = new JLabel("JAJAR GENJANG");
    ...
    public ViewJajarGenjang(){
        
      setVisible(true);
        setTitle("Halaman Menu Jajar Genjang");
        setSize(1000, 620);
        ...
        SubHeader1.setBounds(370,105,400,35);
        add(SubHeader2);
