...
public class ViewLingkaran extends JFrame{
    
    //Membuat JLabel
    JLabel Header = new JLabel("MENU HITUNG");
    JLabel SubHeader1 = new JLabel("LINGKARAN");
    ...
    public ViewLingkaran(){
        setVisible(true);
        setTitle("Halaman Menu Lingkaran");
        setSize(1000, 620);
        ...
        SubHeader1.setBounds(405,105,400,35);
        add(SubHeader2);
