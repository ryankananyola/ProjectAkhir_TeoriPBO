...
import TigaD.LimasPersegi;
import java.awt.*;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import javax.swing.*;

public class ViewLimasPersegi extends JFrame{
    
    //Membuat JLabel
    JLabel Header = new JLabel("MENU HITUNG");
    JLabel SubHeader1 = new JLabel("LIMAS PERSEGI");
    ...
    public ViewLimasPersegi(){
        
        setVisible(true);
        setTitle("Halaman Menu Limas Persegi");
        setSize(1000, 620);
        ...
        SubHeader1.setBounds(377,105,400,35);
        add(SubHeader2);
        ...
        tombolHitung.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    LimasPersegi limasPersegi = new LimasPersegi(sisi, tinggi);
                    double volume = limasPersegi.hitungVolume();
