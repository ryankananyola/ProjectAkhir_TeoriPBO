...
import TigaD.CincinBola;
import java.awt.*;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import javax.swing.*;

public class ViewCincinBola extends JFrame{
    
    //Membuat JLabel
    JLabel Header = new JLabel("MENU HITUNG");
    JLabel SubHeader1 = new JLabel("CINCIN BOLA");
    JLabel SubHeader2 = new JLabel("Silahkan masukkan nilai");
    JLabel labelJariBola = new JLabel("Jari-Jari Bola (cm)");
    JLabel labelJariCincin = new JLabel("Jari-Jari Cincin (cm)");
    JLabel labelHasil = new JLabel("Hasil Hitung =");
    JLabel labelCm3 = new JLabel("cm^3");
    JLabel labelHasilHitung = new JLabel();
    
    //Membuat JTextField
    JTextField inputJariBola = new JTextField();
    JTextField inputJariCincin = new JTextField();
    ...
    public ViewCincinBola(){
        
        setVisible(true);
        setTitle("Halaman Menu Cincin Bola");
        setSize(1000, 620);
        ...
        SubHeader1.setBounds(395,105,400,35);
        add(SubHeader2);
        SubHeader2.setFont(new Font("Times New Roman", Font.BOLD, 14));
        SubHeader2.setBounds(425,165,400,35);
        add(labelJariBola);
        labelJariBola.setBounds(350,220,300,25);
        add(labelJariCincin);
        labelJariCincin.setBounds(350,290,300,25);
        add(labelHasil);
        ...
        add(inputJariBola);
        inputJariBola.setBounds(350,250,300,30);
        add(inputJariCincin);
        inputJariCincin.setBounds(350,320,300,30);
        ...
        tombolHitung.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    double jariBola = Double.parseDouble(inputJariBola.getText());
                    double jariCincin = Double.parseDouble(inputJariCincin.getText());
                    CincinBola cincinBola = new CincinBola(jariBola, jariCincin);
        ...
        tombolReset.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e) {
                inputJariBola.setText("");
                inputJariCincin.setText("");
