...
import TigaD.Tembereng;
import java.awt.*;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import javax.swing.*;

public class ViewTembereng extends JFrame {
    
    //Membuat JLabel
    JLabel Header = new JLabel("MENU HITUNG");
    JLabel SubHeader1 = new JLabel("TEMBERENG");
    JLabel SubHeader2 = new JLabel("Silahkan masukkan nilai");
    JLabel labelJariJari = new JLabel("Jari-Jari (cm)");
    JLabel labelTinggi = new JLabel("Tinggi Tembereng (cm)");
    ...
    public ViewTembereng(){
        
        setVisible(true);
        setTitle("Halaman Menu Tembereng");
        setSize(1000, 620);
        ...
        SubHeader1.setBounds(401,105,400,35);
        add(SubHeader2);
        ...
        tombolHitung.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Tembereng tembereng = new Tembereng(jariJari, tinggi);
